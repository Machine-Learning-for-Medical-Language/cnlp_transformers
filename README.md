...
If you are installing to use the library unmodified in your own code or 
to run the included REST APIs, you can install without cloning:
...
If you want to modify code (for fine-tuning), then install locally:
